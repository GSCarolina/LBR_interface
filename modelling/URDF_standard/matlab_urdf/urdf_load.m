...
folder_ur3e = ['C:\Users\Carolina\Desktop\net_shared\ur3e-modelling\functions'];
folder_ee = ['C:\Users\Carolina\Desktop\net_shared\ur3e-modelling\'];
addpath(folder_ur3e);
% lbr model address:
folder_lbr = 'C:\Users\Carolina\LSR Dropbox\Carolina Gomez Salvatierra\Thesis\Robot model\URDFv2\matlab_urdf';
addpath(folder_lbr);
%% Load the Robot
...
load([folder_lbr '\' 'lbrMed_param.mat']);
load([folder_ee 'eeConfig.mat']);
