...
folder_model = ['C:\Users\Carolina\Desktop\net_shared\LBR_interface\matlab\Windows\robert_urdf'];
...
%[robert, robert_solver] = initialization_robot('robert_matlab.urdf')
%save([folder_model '\' 'robert_matlab.mat'], 'robert', 'robert_solver');
%Otherwise
disp('Loading robot model...');
load([folder_model '\' 'robert_param.mat']);
